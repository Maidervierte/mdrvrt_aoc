...
for path in wire1:
    match path[0]:
        case "R":
            for x in range(cur_pos[0], cur_pos[0] + int(path[1:]) + 1):
                cur_pos = (x, cur_pos[1], i)
                i += 1
                visited_w1.add(cur_pos)
                visited_w1_2.add((cur_pos[0], cur_pos[1]))
        case "L":
            for x in range(cur_pos[0], cur_pos[0] - int(path[1:]) - 1, -1):
                cur_pos = (x, cur_pos[1], i)
                i += 1
                visited_w1.add(cur_pos)
                visited_w1_2.add((cur_pos[0], cur_pos[1]))
        case "U":
            for y in range(cur_pos[1], cur_pos[1] + int(path[1:]) + 1):
                cur_pos = (cur_pos[0], y, i)
                i += 1
                visited_w1.add(cur_pos)
                visited_w1_2.add((cur_pos[0], cur_pos[1]))
        case "D":
            for y in range(cur_pos[1], cur_pos[1] - int(path[1:]) - 1, -1):
                cur_pos = (cur_pos[0], y, i)
                i += 1
                visited_w1.add(cur_pos)
                visited_w1_2.add((cur_pos[0], cur_pos[1]))
